...
packages="librewolf NetworkManager PrismLauncher Signal-Desktop alacritty alsa-pipewire blender btop dunst fastfetch font-awesome galculator gimp gnome-keyring gnome-themes-extra gtk-engine-murrine i3lock imv libreoffice mpv neofetch neovim nwg-look pavucontrol pipewire qbittorrent rofi sassc scrot starship steam ufw unclutter-xfixes wine wine-gecko wine-mono xclip xdg-utils yazi zsh"
