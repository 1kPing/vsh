...
packages="libxcb-devel pam-devel zig NetworkManager PrismLauncher Signal-Desktop alacritty alsa-pipewire awesome blender brightnessctl btop dunst fastfetch font-awesome galculator gimp git gnome-keyring gnome-themes-extra gtk-engine-murrine i3lock imv libreoffice librewolf libxcb mpv neovim nwg-look pam pavucontrol pipewire pipewire-devel qbittorrent rofi sassc scrot starship steam ufw wine wine-gecko wine-mono xev xorg xauth yazi zsh"
